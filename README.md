# Calctastrophe – 3lb Double Vertical Spinner

<p align="center">
  <img width="401" height="347" src="https://github.com/user-attachments/assets/0d6fe3ec-ef85-4bea-948e-6395743bc255" />
  <img width="355" height="346" src="https://github.com/user-attachments/assets/ac9ff7a1-205c-41d2-8833-1d5ab004a76f" />
</p>

Calctastrophe is our 3lb double vertical spinner built for NHRL and other combat robotics events. It runs two belt-driven vertical spinners that reach nearly 20,000 RPM, supported by a high-angled defensive wedge and forks that help us stay in control during engagements. For drive, we use a four-wheel belted system powered by brushed Dartbox Pro (Viper) motors, giving us solid pushing power and reliability around the arena.
...
We tried to balance competitive performance, durability, and cost while staying within our school’s manufacturing capabilities:

- **AR500** – Weapon  
- **6061 Aluminum** – Forks (Waterjet)
- **5052 Aluminum** – Wedge  
...
The robot’s twin belt-driven vertical spinners provide the main offensive power, while the high defensive wedge helps us survive big hits and stay in control of engagements. The four-wheel belt drive offers consistent traction and good handling, and the brushed Dartbox Pro motors provide a solid balance of torque and reliability for the weight class.
...
| Component | Details |
|---|---|
| Weapon | Dual vertical belt-driven spinners |
| Speed | ~20,000 RPM |
| Battery | 80C 900mAh 4S LiHV |
| Drive | 4-wheel belt drive, brushed Dartbox Pro (Viper) motors |
| Frame Materials | CF Nylon and UHMW |
| Weapon Material | AR500 |
| Manufacturing | Built in-house using school CNC, waterjet, and 3D printers |


## Why We Designed Calctastrophe

As President and Vice-President of our school’s combat robotics club, we wanted to build something that would inspire others to take on ambitious projects of their own. With Calctastrophe, our goal was to prove that a competitive beetleweight robot could be built primarily with materials and machines available to students. We also want to encourage other club members to push their designs further and make the most of the resources we have.


## Wiring Diagram

<p align="center">
  <img width="428" height="356" src="https://github.com/user-attachments/assets/846ae7c2-89d2-4062-8507-6834ed40bc95" />
</p>
